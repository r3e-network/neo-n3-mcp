...
/**
 * CLI entrypoint for the MCP 2026-07-28 stateless HTTP transport.
 *
 ...
 *   MCP_HTTP_MAX_CONCURRENT_REQUESTS  in-flight request cap (default 128)
 *   MCP_HTTP_MAX_SUBSCRIPTIONS        subscriptions/listen cap (default 128)
 *
