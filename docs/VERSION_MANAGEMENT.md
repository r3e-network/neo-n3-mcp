...
# Bump patch version (1.7.1 → 1.7.2)
npm run version:patch

# Bump minor version (1.7.1 → 1.8.0)
npm run version:minor

# Bump major version (1.7.1 → 2.0.0)
...
1. **Version Mismatch**:
   ...
   rg -n "1\.7\.1" package.json package-lock.json src/version.ts config/docker.json docs/CHANGELOG.md
   ```
