            ...
            .then(response => {
                if (response.ok) {
                    connectionStatus.innerHTML = `
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 64 64" fill="none" class="ai-icon">
                            <circle cx="32" cy="32" r="28" fill="currentColor" opacity="0.2"/>
                            <rect x="18" y="16" width="28" height="24" rx="6" stroke="currentColor" stroke-width="2"/>
                            <path d="M32 10V16" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                            <circle cx="32" cy="8" r="2" fill="currentColor"/>
                            <circle cx="24" cy="26" r="3" fill="currentColor"/>
                            <circle cx="40" cy="26" r="3" fill="currentColor"/>
                            <path d="M24 36h16" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                            <path d="M25 45L25 40" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                            <path d="M39 45L39 40" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                            <path d="M32 52L32 48" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                        </svg>
                        AI Integration`;
